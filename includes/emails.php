...
function pmproacr_email_templates( $templates ) {
	$templates['pmproacr_reminder_1'] = array(
		...
		'body'        => '<p>' . esc_html__( 'You have almost finished purchasing your !!membership_level_name!! membership at !!sitename!!.', 'pmpro-abandoned-cart-recovery' ) . '</p><p><a href="!!checkout_url!!">' . esc_html__( 'Complete Your Purchase', 'pmpro-abandoned-cart-recovery' ) . '</a></p>',
	...
	$templates['pmproacr_reminder_2'] = array(
		...
		'body'        => '<p>' . esc_html__( 'It looks like you may have forgotten to complete your purchase of the !!membership_level_name!! membership at !!sitename!!.', 'pmpro-abandoned-cart-recovery' ) . '</p><p><a href="!!checkout_url!!">' . esc_html__( 'Complete Your Purchase', 'pmpro-abandoned-cart-recovery' ) . '</a></p>',
	...
	$templates['pmproacr_reminder_3'] = array(
		...
		'body'        => '<p>' . esc_html__( 'This is your final reminder to complete your purchase of the !!membership_level_name!! membership at !!sitename!!.', 'pmpro-abandoned-cart-recovery' ) . '</p><p><a href="!!checkout_url!!">' . esc_html__( 'Complete Your Purchase', 'pmpro-abandoned-cart-recovery' ) . '</a></p>',
